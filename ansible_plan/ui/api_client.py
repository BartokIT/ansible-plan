...
# Everything that means "the backend could not answer": refused or reset
# connections, timeouts, a backend going away mid-response (the UI polls it
# while the CLI is shutting it down), and error statuses.
BACKEND_ERRORS = (httpx.TransportError, httpx.HTTPStatusError)
